...
var titleField = document.getElementById('id_name');
titleField.onblur = getSlug;

function getSlug() {
    var titleText = document.getElementById('id_name');
    var txt = titleText.value
    console.log(txt);
    if(txt == undefined)
        return
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            setSlug(this.responseText);
        }
    };
    
    xhttp.open("GET", "/panel/admin/blog/post/utils/get-slug/" + titleText.value, true);
    xhttp.send();
}

function setSlug(respone) {
    console.log("set slug:" + respone);
    var slugText = respone;
