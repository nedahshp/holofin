    ...
    if ("undefined" != typeof $.fn.cropper) {
        ...
        $('[data-toggle="tooltip"]').tooltip(), e.on({
            ...
            var a, t, n = $(this),
                o = n.attr("name"),
                i = n.prop("type");
            e.data("cropper") && ("checkbox" === i ? (c[o] = n.prop("checked"), a = e.cropper("getCropBoxData"), t = e.cropper("getCanvasData"), c.built = function () {
                e.cropper("setCropBoxData", a), e.cropper("setCanvasData", t)
            }) : "radio" === i && (c[o] = n.val()), e.cropper("destroy").cropper(c))
