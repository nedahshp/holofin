    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deactivate_reason', models.PositiveSmallIntegerField(choices=[(0, 'نامشخص'), (1, 'غیر فعال توسط مدیر'), (2, 'عدم تایید موبایل'), (3, 'عدم تایید ایمیل')], default=0, verbose_name='غیرفعال به دلیل')),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True, verbose_name='ایمیل')),
                ('address', models.TextField(blank=True, null=True, verbose_name='آدرس')),
                ('birth_date', models.DateField(blank=True, null=True, verbose_name='تاریخ تولد')),
                ('role', models.IntegerField(choices=[(0, 'مدیر'), (1, 'کاربر')], default=1, verbose_name='نقش')),
